        ...
        <div className='bg-white rounded-lg shadow-xl p-8'>
          <div className='space-y-4'>
            <a
              ...
              className='w-full flex items-center justify-center gap-3 py-3 bg-white border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition font-medium text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed inline-flex'
            >
              <svg
            ...
            <a
              ...
              className='w-full flex items-center justify-center gap-3 py-3 bg-[#24292F] text-white rounded-lg hover:bg-[#1b1f23] transition font-medium disabled:opacity-50 disabled:cursor-not-allowed inline-flex'
            >
